...
const HomePage = () => {
  return (
    <div class="mt-[15vh] animate-fade-in-up">
      <h1 class="font-league text-8xl font-bold hover:text-gray-700 transition duration-500 transform hover:-translate-y-2 mb-1">
        Hi, I'm Dan Yu.
      </h1>
      <h2 class="font-league font-semibold text-gray-700 text-8xl hover:text-black transition duration-500 transform hover:-translate-y-2 mb-7 w-content">
